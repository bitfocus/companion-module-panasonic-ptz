...
export const SERIES_SPECS = [
...

	{
		...
		capabilities: {
			...
			presetThumbnails: true,
			presetTime: true,
			pull: { ptz: false, cam: ['QSL:B6', 'QSL:B7', 'QSL:BB'], web: ['get_rtmp_status', 'get_srt_status', 'get_ts_status'] },
			recordSD: false,
			restart: true,
...

	{
		...
		capabilities: {
			...
			panTilt: false,
			pedestal: { cmd: 'OSJ:0F', offset: 0x800, limit: 200, step: 1, hexlen: 3 },
			poll: { ptz: ['GF', 'GI', 'GZ', 'TAA'], cam: ['QAF', 'QAW', 'QBR', 'QBP', 'QFT', 'QGU', 'QIS', 'QRP', 'QSD:4F', 'QSG:39', 'QSG:3A', 'QSI:20', 'QSJ:0F'], web: ['get_state'] },
			power: false,
			preset: false,
			presetSpeed: false,
			presetThumbnails: false,
			presetTime: false,
			pull: { ptz: ['GF', 'GI', 'GZ', 'TAA'], cam: ['QAF', 'QAW', 'QBR', 'QBP', 'QFT', 'QGU', 'QIS', 'QRP', 'QSD:4F', 'QSG:39', 'QSG:3A', 'QSI:20', 'QSJ:0F'], web: ['get_state'] },
			recordSD: true,
			restart: false,
			shutter: false,
			streamRTMP: true,

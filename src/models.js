    ...
    SERIES_SPECS: [
        {   // Includes all Actions / Variabels / Feedbacks
            ...
            actions: {
                ...
                OTAF: true,
                iris: true,
                gain: {cmd: 'OGU:', dropdown: c.CHOICES_GAIN_OTHER()},
                shut: {cmd: 'OSH:', dropdown: c.CHOICES_SHUTTER_OTHER},
                ped: {cmd: 'OTP:', dropdown: c.CHOICES_PEDESTAL_OTHER()},
                filter: {cmd: 'OFT:', dropdown: c.CHOICES_FILTER_OTHER()},
                preset: true,
                speedPset: true,
                timePset: true,
                power: true,

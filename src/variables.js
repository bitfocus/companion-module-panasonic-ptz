...
module.exports = {
    ...
    setVariables: function (i) {
        ...
        if (SERIES.variables.version == true) {variables.push({ name: 'version', label: 'Firmware Version' });}
        if (SERIES.variables.error == true) {variables.push({ name: 'error', label: 'PTZ Error Codes' });}
        if (SERIES.variables.ins == true) {variables.push({ name: 'ins', label: 'Install Position' });}
